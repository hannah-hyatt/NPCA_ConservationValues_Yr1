...
## 3.) Reclassify: IVC_ELCODE = 1, everything else 0
...
# Input Variables
hucgrid = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\HUC12_GAriver"
dataLCM = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\LCM_MaskGAriver_resample" #this version of the LCM has been clipped to BITH buffered boundary and resampled to 30m
dataRuderal = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\GAriver_Ruderal5Cell" # UPDATE
dataFireDep = r"S:\Data\External\LANDFIRE_Fire_Departure\LF2020_VDep_220_CONUS\LF2020_VDep_220_CONUS\Tif\LC20_VDep_220.tif"
dataLCVC = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\LCVC_GAriverMask_Lookup"
...
ZonalSt_Value_LCM = fr"ZonalSt_GAriver_LCM"
...
ZonalSt_Value_InvRisk = fr"ZonalSt_GAriver_InvRisk"
...
tmp_FireDep_tif = fr"tmp_GAriver_Inv.tif"
tmp_FireDep_tif = arcpy.sa.ExtractByMask(in_raster=dataFireDep, in_mask_data=hucgrid)
ZonalSt_Value_FireDep = fr"ZonalSt_GAriver_InvRisk"
...
ZonalSt_Value_LCVC = fr"ZonalSt_GAriver_LCVC"
