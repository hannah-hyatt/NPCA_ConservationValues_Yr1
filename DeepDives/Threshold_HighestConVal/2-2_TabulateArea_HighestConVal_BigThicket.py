...
# calculated the top 10% quantile of the conservation value in Big Thicket study area (conservation value = 12)
# created a binary raster of that value inside Big Thicket study area
