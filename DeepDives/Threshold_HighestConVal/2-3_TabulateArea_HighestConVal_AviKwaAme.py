...
# calculated the top 10% quantile of the conservation value in AviKwaAme study area (conservation value = 14)
# created a binary raster of that value inside AviKwaAme study area
...
# Outputs:
# to be used in R code which creates donut charts showing the protection status managers of the areas of highest conservation value inside of AviKwaAme Study area
...
#set variables
SA_AnalysisLayer = r"S:\Projects\NPCA\Data\Intermediate\AviKwaAmeDeepDive.gdb\PADUS_AviKwaAme_AnalysisLayer"
...
print ("tabulate area managed lands inside areas of highest conservation value in AviKwaAme complete")
...
print ("tabulate area GAP status inside areas of highest conservation value in AviKwaAme complete")
