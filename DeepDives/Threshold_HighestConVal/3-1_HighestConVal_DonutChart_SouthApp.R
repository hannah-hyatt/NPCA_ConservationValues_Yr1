...
inputTabAreaGAP <- "S:/Projects/NPCA/Data/Intermediate/GAP_Analysis_Species.gdb/TabArea_SAconcal_GAPstatus" # UPDATE Input Tabulate Area table - Managed Lands or GAP status focused
...
inputTabAreaManaged <- "S:/Projects/NPCA/Data/Intermediate/GAP_Analysis_Species.gdb/TabArea_SAconval_ManagedLands"
