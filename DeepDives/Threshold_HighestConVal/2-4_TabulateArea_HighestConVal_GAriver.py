...
# calculated the top 10% quantile of the conservation value in GA River System study area (conservation value = 13)
...
# Outputs:
# to be used in R code which creates donut charts showing the protection status managers of the areas of highest conservation value inside of GA River System Study area
...
#set variables
SA_AnalysisLayer = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\PADUS_GAriver_AnalysisLayer"
SA_ConVal = r"S:\Projects\NPCA\Data\Intermediate\ConservationValue\ConVal_GAriver_Binary.tif"
IUCN_CONUS = r"S:\Projects\_Workspaces\Hannah_Hyatt\ForestEndowment\Data\Intermediate.gdb\IUCNecosystems_CONUS"
TabAreaGAP_out = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\TabArea_SAconval_GAPstatus"
TabAreaMang_out = r"S:\Projects\NPCA\Data\Intermediate\GeorgiaRiverSystemDeepDive.gdb\TabArea_SAconval_ManagedLands"
print ("variables set")
...
print ("tabulate area managed lands inside areas of highest conservation value in GA River System complete")
...
print ("tabulate area GAP status inside areas of highest conservation value in GA River System complete")
