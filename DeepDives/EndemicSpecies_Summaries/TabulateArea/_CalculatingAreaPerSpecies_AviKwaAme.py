...
tablepath = r"S:\Projects\NPCA\Workspace\Hannah_Hyatt\SpeciesSummaries\Int_ModelsTbls_DEriverWatershed" # UPDATE
...
cutecodelist = []
cutecode_file = open(r'S:\Projects\NPCA\Data\SpeciesLists\hypergrid_spslist\DelawareRiverWatershed_SpeciesList.txt', 'r') # UPDATE IF NEEDED
