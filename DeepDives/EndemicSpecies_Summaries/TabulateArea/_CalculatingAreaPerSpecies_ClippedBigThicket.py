...
# Set Variables
Boundary = r"S:\Projects\NPCA\Data\Intermediate\BigThicketDeepDive.gdb\BigThicket_PADUS_Clip_AnalysisLayer" # UPDATE
tablepath = r"S:\Projects\NPCA\Workspace\Hannah_Hyatt\SpeciesSummaries\Int_ModelTbls_BigThicket" # UPDATE
outTable = r"MoBIshms_TabAreaMerge" # UPDATE
Boundary_field = "NPCA_Status_GAP_StudyArea" # UPDATE

# Create Cutecode List
cutecodelist = []
cutecode_file = open('S:\Projects\SFI\Phase_III_US_Canada\Workspace\Ellie_Linden\MoBI\SpeciesList\SpeciesList.txt', 'r') # UPDATE IF NEEDED
