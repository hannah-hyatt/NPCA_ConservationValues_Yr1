...
tablepath = r"S:\Projects\NPCA\Workspace\Hannah_Hyatt\SpeciesSummaries\Int_ModelsTbls_BigThicket_v2" # UPDATE
outTable = r"MoBIshms_TabAreaMerge" # UPDATE
Boundary_field = "NPCA_Status_GAP_StudyArea" # UPDATE

# Create Cutecode List
cutecodelist = []
cutecode_file = open(r'S:\Projects\NPCA\Data\SpeciesLists\hypergrid_spslist\BigThicket_SpeciesList.txt', 'r') # UPDATE IF NEEDED
