...
# Set Variables
Boundary = r"S:\Projects\NPCA\Data\Intermediate\GAP_Analysis.gdb\StudyAreas_PADUS_CONUS_AnalysisLayer_clippedtoEast" # UPDATE
tablepath = r"S:\Projects\NPCA\Workspace\Hannah_Hyatt\SpeciesSummaries\Int_ModelTbls_GAriver" # UPDATE
outTable = r"MoBIshms_TabAreaMerge_GAriver" # UPDATE
Boundary_field = "NPCA_Status_GAP_StudyArea" # UPDATE

# Create Cutecode List
cutecodelist = []
cutecode_file = open(r'S:\Projects\NPCA\Data\SpeciesLists\hypergrid_spslist\GeorgiaRiverSystem_SpeciesList.txt', 'r') # UPDATE IF NEEDED
