...
inputTabAreaGAP <- read.csv("S:/Projects/NPCA/Workspace/Hannah_Hyatt/SpeciesSummaries/Int_ModelTbls_AviKwaAme_NatMon/Int_ModelTbls_AviKwaAme_NatMonGAPstsChng.csv") # UPDATE Input Tabulate Area table - Managed Lands or GAP status focused
...
write.csv(StudyAreaSpecies_subset3, "S:/Projects/NPCA/Workspace/Hannah_Hyatt/SpeciesSummaries/AKA_SpeciesDonutCharts/AKA_EndSps_PotentialProtection_final.csv")
