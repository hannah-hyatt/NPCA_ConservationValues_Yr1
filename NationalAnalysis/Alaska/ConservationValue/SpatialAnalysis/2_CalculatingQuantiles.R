...
### Set Workspaces ###
inWS <- "S:/Projects/NPCA/Workspace/Hannah_Hyatt/NationalAnalysis/Alaska/ConservationValue/1_DecileCalculations/"
outWS <- "S:/Projects/NPCA/Workspace/Hannah_Hyatt/NationalAnalysis/Alaska/ConservationValue/2_Percentiles/"
...
###################################
 ...
 RSR.percentiles <-raster::quantile(RSR, probs=thresholds, ncells=1000000)
